describe('Test utilisateur', () => {
    it('Ajout dun compte utilisateur', () => {
        ...
        cy.get('#register_email').clear().type("laura2@test.com")
        ...
        cy.get('strong').should("contain", "Le compte laura2@test.com a été ajouté en BDD")
    })
...
describe('Test utilisateur', () => {
    it('Ajout dun compte utilisateur', () => {
        ...
        cy.get('#register_password_second').clear().type("1234")
        cy.get('#register_Ajouter').click()
        cy.get('strong').should("contain", "Le compte laura2@test.com existe déja")
    })
